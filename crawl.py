...
class Crawler():
    ...
    def animate_work(force=False, times=1):
        Crawler.anim_calls = (Crawler.anim_calls + 1) % 500
...
crawler.appendUrl('https://frr.wikipedia.org/wiki/National_Diet_Library')
crawler.appendUrl('https://af.wikipedia.org/wiki/Tuisblad')
crawler.appendUrl('https://pam.wikipedia.org/wiki/Luna,_Apayao')
crawler.appendUrl('https://eu.wikipedia.org/wiki/Lucio_Marineo_S%C3%ADculo')
crawler.appendUrl('https://war.wikipedia.org/wiki/Andrena_flavofacies')
crawler.appendUrl('https://ceb.wikipedia.org/wiki/Aoso_Yama')
crawler.appendUrl('https://sv.wikipedia.org/wiki/L%C3%A5ngserieb%C3%B6cker')
crawler.appendUrl('https://nl.wikipedia.org/wiki/Giovanni_Battista_Piranesi')
crawler.appendUrl('https://it.wikipedia.org/wiki/Pagina_principale')
crawler.appendUrl('https://ms.wikipedia.org/wiki/Laman_Utama')
crawler.appendUrl('https://fr.wikipedia.org/wiki/William_Gallacher')
crawler.crawl()
