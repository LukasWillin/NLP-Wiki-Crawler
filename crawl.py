...
spider.crawl()
# spider.crawl('https://simple.wikipedia.org/wiki/Main_Page', 5000)
# spider.crawl('https://da.wikipedia.org/wiki/Forside', 1000)
# spider.crawl('https://bs.wikipedia.org/wiki/Po%C4%8Detna_strana', 1000)
# spider.crawl('https://frr.wikipedia.org/wiki/National_Diet_Library', 1000)
# spider.crawl('https://af.wikipedia.org/wiki/Tuisblad', 1000)
# spider.crawl('https://pam.wikipedia.org/wiki/Luna,_Apayao', 1000)
# spider.crawl('https://eu.wikipedia.org/wiki/Lucio_Marineo_S%C3%ADculo', 1000)
# spider.crawl('https://war.wikipedia.org/wiki/Andrena_flavofacies', 1000)
# spider.crawl('https://ceb.wikipedia.org/wiki/Aoso_Yama', 1000)
# spider.crawl('https://sv.wikipedia.org/wiki/L%C3%A5ngserieb%C3%B6cker', 1000)
# spider.crawl('https://nl.wikipedia.org/wiki/Giovanni_Battista_Piranesi')
# spider.crawl('https://it.wikipedia.org/wiki/Pagina_principale', 1000)
# spider.crawl('https://ms.wikipedia.org/wiki/Laman_Utama', 1000)
# spider.crawl('https://fr.wikipedia.org/wiki/William_Gallacher', 1000)
